package rpt.tool.mementobibere.java.userinfo.custom;
...
public class MaterialProgressBar extends View
{
  ...
  private void parseAttributes(TypedArray a) {
    ...
    circleRadius =
        (int) a.getDimension(R.styleable.MaterialProgressBar_matProg_circleRadius, circleRadius);
    ...
    float baseSpinSpeed =
        a.getFloat(R.styleable.MaterialProgressBar_matProg_spinSpeed, spinSpeed / 360.0f);
    spinSpeed = baseSpinSpeed * 360;

    barSpinCycleTime =
        a.getInt(R.styleable.MaterialProgressBar_matProg_barSpinCycleTime, (int) barSpinCycleTime);
