...
import rpt.tool.mementobibere.basic.appbasiclibs.mycustom.MaterialProgressBar
...
class Alert_Helper
    ...
    fun customAlert(msg: String?) {
        ...
        val customToastText: TextView = toastView.findViewById<TextView>(R.id.customToastText)
    ...
    fun Show_Error_Dialog(msg: String?) {
        if (Constant.DEVELOPER_MODE) Show_Alert_Dialog(msg)
    }
}
