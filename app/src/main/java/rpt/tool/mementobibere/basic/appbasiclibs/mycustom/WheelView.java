...
//    private ScrollView scrollView;
    ...
    public WheelView(Context context) {
        super(context);
        init(context);
        uf=new Utility_Function(context,(Activity)context);
    ...
    private TextView createView(String item)
    {
        ...
        if(uf.isTablet())
            tv.setTextSize(TypedValue.COMPLEX_UNIT_SP,30);//20
        else
            tv.setTextSize(TypedValue.COMPLEX_UNIT_SP,14);//20

        tv.setText(item);
        tv.setGravity(Gravity.CENTER);
        int padding = dip2px(15);//15
        tv.setPadding(padding, padding, padding, padding);
        if (0 == itemHeight)
        {
            itemHeight = getViewMeasuredHeight(tv);
            d(TAG, "itemHeight: " + itemHeight);
            views.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.FILL_PARENT, itemHeight * displayItemCount));
...
//        d(TAG, "l: " + l + ", t: " + t + ", oldl: " + oldl + ", oldt: " + oldt);
//        try {
...
//                    position = divided + offset;
//                    d(TAG, ">down...position: " + position);
//                }else if(scrollDirection == SCROLL_DIRECTION_UP){
//                    position = divided + offset + 1;
//                    d(TAG, ">up...position: " + position);
//                }
//            }else{
...
//            position = divided + offset + 1;
        ...
        for (int i = 0; i < childSize; i++)
        {
            ...
            {
                //itemView.setBackgroundColor(context.getResources().getColor(R.color.button_blue));
    ...
    public void setBackgroundDrawable(Drawable background)
    {
        ...
        {
            paint = new Paint();
            paint.setColor(Color.parseColor("#4F4F4F"));//#83cde6
    ...
    private int getViewMeasuredHeight(@NonNull View view) {
