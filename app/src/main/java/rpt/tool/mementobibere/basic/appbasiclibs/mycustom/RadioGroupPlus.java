...
//        attributes.recycle();
    ...
    public String getCheckedRadioButtonTag(int mCheckedId)
    {
    	RadioButton rd=(RadioButton) findViewById(mCheckedId);
    	return ""+rd.getTag();
    }
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
         ...
         */
        @Override
        protected void setBaseAttributes(@NonNull TypedArray a,
