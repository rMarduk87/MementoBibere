package rpt.tool.mementobibere.basic.appbasiclibs.mycustom.justify;
...
public class MyJustifiedTextView extends JustifiedTextView
{
    ...
    protected void onAttachedToWindow() {
        ...
        /*Typeface lbl_tf = Typeface.createFromAsset(mContext.getAssets(),"Assistant-Regular.ttf");
        setTypeface(lbl_tf);*/
    }
    ...
    private int getLineAtCoordinate(final Layout layout, final float y) {
    ...
    private int getOffsetAtCoordinate(final Layout layout, final int line, final float x) {
