...
package rpt.tool.mementobibere.utils.view.custom.picker;
...
public class HorizontalPicker extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (values != null) {
            for (int i = 0; i < values.length; i++) {
                ...
                textPaint.setColor(Color.parseColor("#523D6B70"));
                //textPaint.setTextSize(75);

                if(selectedItem==i) {
                    textPaint.setColor(Color.parseColor("#3D6B70"));
                    ...
                    /*runnable = new Runnable() {
                        @Override
                        public void run() {
                            textPaint.setTextSize(current_progress);
                            Log.d("current_progress",""+current_progress);
                    ...
                    animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                        ...
                        public void onAnimationUpdate(ValueAnimator valueAnimator) {
                            ...
                            Log.d("addUpdateListener",""+animatedValue);
                            textPaint.setTextSize(animatedValue);
                        }
                    });
                ...
                {
                    //canvas.scale(1f, 2f);
                    layout.animate().translationY(0).setDuration(1000).start();
                }*/
    ...
    public void setSideItems(int sideItems) {
        if (this.sideItems < 0) {
            ...
            calculateItemSize(getWidth(), getHeight()+100);
        }
    }
